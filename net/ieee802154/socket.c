...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_ieee802154_sock_sendmsg(struct kiocb *iocb, struct socket *sock, struct msghdr *msg, size_t len)
{
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_raw_sendmsg(struct kiocb *iocb, struct sock *sk, struct msghdr *msg, size_t len)
{
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_raw_recvmsg(struct kiocb *iocb, struct sock *sk, struct msghdr *msg, size_t len, int noblock, int flags, int *addr_len)
{
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_dgram_sendmsg(struct kiocb *iocb, struct sock *sk, struct msghdr *msg, size_t len)
{
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_dgram_recvmsg(struct kiocb *iocb, struct sock *sk, struct msghdr *msg, size_t len, int noblock, int flags, int *addr_len)
{
