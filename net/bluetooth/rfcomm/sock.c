...
static int backport_rfcomm_sock_sendmsg(struct kiocb *iocb, struct socket *sock, struct msghdr *msg, size_t len)
{
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4,1,0)
static int backport_rfcomm_sock_recvmsg(struct kiocb *iocb, struct socket *sock, struct msghdr *msg, size_t len, int flags)
{
